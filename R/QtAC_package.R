...
QtAC.maturation <- function(result_mtx, res_stand = "maxweight"){
  ...
  for(num in 1:length){
    ...
    potential[num] <- .QtAC.potential(Adjacent_matrices[[num]])
...
QtAC.network <- function(result_mtx,num_mtx,edge_label = FALSE,dec = 2, layout = "nicely",edge_width = 3,arrow_width = 5,col_node = "palegreen3",col_edge = "steelblue3",vertex_label = "short", title = paste("Network of Adjacency matrix ",times[num_mtx]), save = FALSE,filename = paste("network_",num_mtx, sep = "")){
